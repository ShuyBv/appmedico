...
class VentaDocController extends Controller
{
    public function create()
    {
        $productos = Producto::all();
        $pacientes = Paciente::all();
        return view('doc.ventas', compact('productos', 'pacientes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('docProductos')->with('success', 'Venta registrada con éxito');
    }
