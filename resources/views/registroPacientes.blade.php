        ...
        <div class="bg-white bg-opacity-75 p-8 md:p-10 rounded-lg shadow-xl flex flex-col items-center w-full max-w-2xl"> 
            ...
            <form class="mt-6 w-full grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2 flex justify-between mt-6">
                    ...
                    <button type="button"
                        class="w-2/3 flex justify-center py-2 px-4 border border-grisgob1 text-bs font-medium text-grisgob1 bg-white hover:bg-grisgob1 hover:text-white" onclick="location.href='/secretario'">
                        Regresar
                    </button>
                </div>
            </form>
