                                    ...
                                    <td class="py-2 px-4 text-center">
                                        <div class="flex justify-center">
                                            ...
                                            <form action="{{ route('docProductos.destroy', $producto->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="inline-flex m-1 justify-center py-2 px-4 border border-colorgob1 text-sm font-medium text-colorgob1 bg-white hover:bg-colorgob1 hover:text-white">Eliminar</button>
                                            </form>
                                        </div>
                                    </td>    
                                </tr>
