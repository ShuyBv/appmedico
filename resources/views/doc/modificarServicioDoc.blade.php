            ...
            <div class="bg-white p-8 mb-4 md:p-10 w-1/2 border border-black">
                ...
                <form action="{{ route('docServicios.update', $servicio->id) }}" method="POST">
                    ...
                    <div class="flex-grow flex items-center justify-center mt-6">
                        <button type="button"
                            class="w-full flex justify-center py-2 px-4 ml-2 border border-grisgob1 text-sm font-medium text-grisgob1 bg-white hover:bg-grisgob1 hover:text-white" onclick="location.href='/docServicios'">
                            Regresar
                        </button>
                        <button type="submit"
