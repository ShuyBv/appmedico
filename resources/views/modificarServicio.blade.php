    ...
    <div class="bg-colorgob4 p-2 text-center text-gray-700">
        ...
        <div class="flex justify-center items-center h-full" style="margin-top: 40px;">
            <div class="bg-white p-8 mb-4 md:p-10 w-1/2 border border-black">
                <h2 class="text-2xl font-bold text-black text-center mb-6">Editar Servicio</h2>
                @if(session('success'))
                ...
                <form action="{{ route('verServicios.update', $servicio->id) }}" method="POST">
                    ...
                    <div class="flex-grow flex items-center justify-center mt-6">
                        <button type="button"
                            class="w-full flex justify-center py-2 px-4 ml-2 border border-grisgob1 text-sm font-medium text-grisgob1 bg-white hover:bg-grisgob1 hover:text-white" onclick="location.href='/verServicios'">
                            Regresar
                        </button>
                        <button type="submit"
