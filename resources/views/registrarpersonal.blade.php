...
<body
    ...
    <div class="flex items-center justify-center h-screen" style="margin-top: -40px;">
        <div class="bg-white bg-opacity-80 border border-grisgob1 p-4 md:p-10 shadow-xl flex flex-col items-center w-full max-w-2xl"> 
            <h2 class="text-2xl font-bold text-black">Ingresa los datos para registrar al personal</h2>
            <form class="mt-6 w-full grid grid-cols-2 gap-4" action="{{ route('validar-registro') }}" method="POST">
                ...
                <div>
                    ...
                    <select name="tipoUsuario" id="tipoUsuario"
                        ...
                        <option value="recepcionista">Secretario</option>
                ...
                <div class="col-span-2 flex justify-between mt-6">
                    ...
                    <button type="button"
                        class="w-1/3 flex justify-center py-2 px-4 border border-grisgob1  text-bs font-medium text-bg-grisgob1  hover:bg-grisgob1  hover:text-white" onclick="location.href='/secretario'">
                        Regresar
                    </button>
                </div>
            </form>
