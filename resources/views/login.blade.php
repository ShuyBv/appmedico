...
<body style="background-image: url('img/fondo.png'); background-size: cover; background-position: center; background-attachment: scroll; height: 100vh; margin: 0; padding: 0;">
    ...
    <div class="flex justify-center items-center h-full" style="margin-top: -40px;">
        <div class="bg-opacity-80 bg-white border border-grisgob1 p-4 md:p-10 shadow-xl flex flex-col items-center w-full max-w-md">
            <h2 class="text-2xl font-bold mt-6">Bienvenido, <span class="font-normal">ingresa tus datos</span></h2>
            
            <form class="mt-6 w-full" action="{{ route('verificar-login') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <label for="correo" class="block text-sm font-medium text-gray-700">Correo Electrónico</label>
                    <input type="email" name="correo" id="correo" placeholder="Ingresa tu correo electrónico"
                ...
                <div class="mt-5 text-center text-black text-sm">
                    <span>Aun no tienes cuenta? </span><a href="{{ route('registro') }}" class="font-bold underline">Registrate</a>.
                </div>
            </form>
        </div>
    </div>
