        ...
        <div class="flex-1 flex flex-col p-6">
           <div class="flex justify-end mt-6 items-end">
                <button
                    ...
                    onclick="location.href='/registroPacientes'">
                    Registrar Paciente
                </button>
            </div>
                    ...
                    <tbody>
                        @if (isset($pacientes))
                            ...
                            <tr class="border border-gray-300 hover:bg-grisgob2">
                                    ...
                                    <td class="py-2 px-4 text-center">
                                        <button
                                            class="inline-flex justify-center py-2 px-4 ml-2 border border-grisgob1 text-sm font-medium text-grisgob1 bg-white hover:bg-grisgob1 hover:text-white"
                                            onclick="location.href='{{ route('pacientes.edit', $paciente->id) }}'">Editar</button>
                                        <button
                                            ...
                                            onclick="location.href='{{ route('verPago', $paciente->id) }}'">Pago</button>
                                    </td>                                    
                                </tr>
                            @endforeach
                        @endif
