    ...
    <div class="flex-grow flex items-center justify-center mt-6">
        <div class="w-full max-w-6xl bg-white bg-opacity-75 rounded-lg p-3">
            <div class="flex justify-end mt-4 p-2">
                <button class="border border-colorgob1 text-bs text-colorgob1 hover:bg-colorgob1 hover:text-white px-4 py-2 mr-2" onclick="location.href='/registroPacientes'">Registrar paciente</button>
                <button class="border border-colorgob1 text-bs text-colorgob1 hover:bg-colorgob1 hover:text-white px-4 py-2 mr-2" onclick="location.href='/registrarpersonal'">Registrar personal</button>
                <button class="border border-colorgob3 text-bs text-colorgob3 hover:bg-colorgob3 hover:text-white px-4 py-2 mr-2" onclick="location.href='/personal'">Ver personal</button>
            </div>
            <table class="min-w-full bg-white border border-gray-300">
                <thead>
                    <tr>
                        <th class="py-2 px-4 border-b border-gray-300">Nombre</th>
                        <th class="py-2 px-4 border-b border-gray-300">Cita</th>
                        <th class="py-2 px-4 border-b border-gray-300">Agendar</th>
                        <th class="py-2 px-4 border-b border-gray-300">Detalles de pago</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
