...
<body style="background-image: url('img/fondo.png'); background-size: cover; background-position: center; height: 100vh; margin: 0; padding: 0;">
    ...
    <div class="flex-grow flex items-center justify-center mt-6">
        <div class="w-full max-w-4xl bg-white bg-opacity-75 rounded-lg p-6">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b border-gray-300 text-center">
                            <button class="bg-white text-grisgob1 px-4 py-2 border border-grisgob1 hover:bg-grisgob1 hover:text-white" onclick="location.href='/detallesPacientes'">Ver detalles</button>
                            <button class="bg-white text-colorgob3 px-4 py-2 border border-colorgob3 hover:bg-colorgob3 hover:text-white" onclick="location.href='/detallesPacientes'">Ver Expediente</button>
                            <button class="bg-white text-colorgob1 px-4 py-2 border border-colorgob1 hover:bg-colorgob1 hover:text-white" onclick="location.href='/Consultar'">Consultar</button>
                        </td>                     </tr>
                    <tr>
